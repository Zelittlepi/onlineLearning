...
CREATE TABLE course_activities (
    ...
    description TEXT,
    instructions TEXT,
    activity_type ENUM('ASSIGNMENT', 'QUIZ', 'ANNOUNCEMENT', 'PRACTICE', 'DISCUSSION', 'SURVEY') NOT NULL,
    ...
    submission_type ENUM('FILE', 'TEXT', 'URL', 'MULTIPLE_CHOICE', 'MIXED') DEFAULT 'TEXT',
    is_published BOOLEAN DEFAULT false,
    is_required BOOLEAN DEFAULT true,
    weight DECIMAL(5,2) DEFAULT 1.00,
    grading_method ENUM('MANUAL', 'AUTO', 'PEER') DEFAULT 'MANUAL',
    settings JSON,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE,
...
CREATE TABLE activity_submissions (
    ...
    graded_by BIGINT,
    time_spent_minutes INT DEFAULT 0,
    status ENUM('DRAFT', 'SUBMITTED', 'GRADED', 'RETURNED', 'LATE_SUBMITTED') DEFAULT 'SUBMITTED',
...
CREATE TABLE assignments (
    ...
    due_date TIMESTAMP NULL,
    max_score DECIMAL(5,2) DEFAULT 100.00,
    submission_type ENUM('FILE', 'TEXT', 'URL') DEFAULT 'FILE',
    is_published BOOLEAN DEFAULT false,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE
...
-- Java课程活动
(1, 1, 'Java Programming Assignment #1', 'Create a simple Java program demonstrating basic OOP concepts', 'Write a Java class that includes constructors, methods, and inheritance. Submit your .java files.', 'ASSIGNMENT', DATE_ADD(NOW(), INTERVAL 30 DAY), 100.00, 'FILE', true, NULL, 3, 'MANUAL'),
(1, 1, 'Java Basics Quiz', 'Test your understanding of Java fundamentals', 'Answer all questions within the time limit. You have 2 attempts.', 'QUIZ', DATE_ADD(NOW(), INTERVAL 15 DAY), 50.00, 'MULTIPLE_CHOICE', true, 30, 2, 'AUTO'),
...
-- Python数据分析课程活动
(2, 1, 'Data Analysis Project', 'Analyze real-world dataset', 'Choose a dataset and perform comprehensive analysis using Python. Create visualizations and insights.', 'ASSIGNMENT', DATE_ADD(NOW(), INTERVAL 45 DAY), 150.00, 'FILE', true, NULL, 1, 'MANUAL'),
(2, 1, 'Python Fundamentals Quiz', 'Basic Python syntax and concepts', 'Test your knowledge of Python variables, functions, and data structures.', 'QUIZ', DATE_ADD(NOW(), INTERVAL 20 DAY), 75.00, 'MULTIPLE_CHOICE', true, 45, 2, 'AUTO'),

-- Web开发课程活动
(3, 1, 'HTML/CSS Layout Assignment', 'Create a responsive web page layout', 'Design and implement a responsive website using HTML5 and CSS3. Include mobile-first design.', 'ASSIGNMENT', DATE_ADD(NOW(), INTERVAL 25 DAY), 120.00, 'FILE', true, NULL, 2, 'MANUAL'),
(3, 1, 'JavaScript Fundamentals Quiz', 'JavaScript basics and DOM manipulation', 'Test your knowledge of JavaScript variables, functions, and DOM operations.', 'QUIZ', DATE_ADD(NOW(), INTERVAL 20 DAY), 75.00, 'MULTIPLE_CHOICE', true, 45, 2, 'AUTO');
...
(1, 2, 'Submitted Java OOP assignment with Car and Vehicle classes demonstrating inheritance.', DATE_SUB(NOW(), INTERVAL 2 DAY), 'GRADED', 85.00, 'Good implementation of OOP concepts. Consider adding more comments and error handling.', 1),

-- Java Quiz submissions (student_id = 2)
(2, 2, NULL, DATE_SUB(NOW(), INTERVAL 5 DAY), 'GRADED', 40.00, 'Well done! Review the concepts you missed and try again if needed.', NULL);
...
(2, 1, true, DATE_SUB(NOW(), INTERVAL 10 DAY), 15),
(2, 2, true, DATE_SUB(NOW(), INTERVAL 9 DAY), 12),
(2, 3, false, NULL, 8),
(3, 1, true, DATE_SUB(NOW(), INTERVAL 15 DAY), 20),
(3, 2, true, DATE_SUB(NOW(), INTERVAL 14 DAY), 15),
(3, 3, true, DATE_SUB(NOW(), INTERVAL 13 DAY), 25),
(3, 4, true, DATE_SUB(NOW(), INTERVAL 12 DAY), 30);
...
-- 完成！在线教育系统数据库已成功初始化
SELECT 'Online Education System MySQL database setup completed successfully!' as status;
