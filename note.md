请帮我设计一个在线教育系统（web应用），包括前端后端数据库

技术栈：

**后端:** Spring Boot + MyBatisPlus + Spring Security 等
**前端:** React+ Vite + 自定义CSS设计系统 等

数据库：使用supabase数据库，连接信息如下



```bash
postgresql://postgres.vbdzzryvrsqpmdrkhvxr:180031@aws-1-us-east-1.pooler.supabase.com:5432/postgres
postgresql://postgres.vbdzzryvrsqpmdrkhvxr:180031@aws-1-us-east-1.pooler.supabase.com:5432/postgres
```
...
登录功能一定要实现，前端调用后端的接口，后端查询数据库，其他功能可以先定个框架后续慢慢加，确保代码能运行
